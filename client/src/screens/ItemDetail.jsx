      ...
      <div className="coffee-data">
        <div className="name-pic-container">
          <div className="name-link-container">
            <Link to="/coffees" className="link-coffees">
              Coffees/
            </Link>
          ...
          <img
            className="image"
            src={coffee.picture}
            alt="Can't find the beans"
          />
        </div>
        <div className="coffee-stats-container">
          <h5 className="coffee-stats">
            Origin:
            <br />
            {coffee.origin}
          </h5>
          ...
          <h5 className="coffee-stats">
            Caffeine Level:
            <br />
            {coffee.caffeine_level}
          </h5>
          <h5 className="add-fav" onClick={() => addToFavorites(coffee.id)}>
            + Add to Favorites
          </h5>
        </div>
      </div>
